...
<script>
     ...
     /*    $(document).ready(function(){
        	...
        	if(srcValue == "affordability"){
            	$(".show-hide").hide();
            	$(".show-hide-coverage").hide();
            } else if(srcValue == "calculateneed"){
            	$(".show-hide").hide();
        	...
        	if(selectedCoverageValue != 0 && selectedCoverageValue != "" && (srcValue == "mlcmain" || srcValue == "calculateneed" || srcValue == "affordability")){
        		$(".show-hide").hide();
        	}  */
   		/*  }); */
        </script>
<script type="text/javascript">
       // selectedValue($("#calc-coverage").val());
            function selectedValue(obj){
                  /* alert(obj.value); */
                  /* var coverageValue = "${sessionProfile.coverage}";
                  if(null != coverageValue && "${src}"=="dropdown") {
                        obj.value = coverageValue;
                        alert(obj.value);
                        return obj;
                  } */
                  return obj;
