...
/*         $(document).ready(function(){
        	...
        	if(selectedCoverageValue != 0 && selectedCoverageValue != "" && srcValue == "mlcmain"){
        		$(".show-hide").hide();
        	}
...
<body onload="loadHowMuchDoINeed(${sessionProfile.coverage},${sessionProfile.annualIncome})">
<!--
...
<!-- End of DoubleClick Floodlight Tag: Please do not remove -->
	...
	<div id="calculator" class="background-wrap" style="display: none">
		...
		<section id="needs-calculator" class="quote" style="display: none">
			<div class="container">
				<div class="row">
	...
	<div id="quote_form" class="background-wrap" style="display: block">
		<section class="quote-header text-center">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
		...
		<section id="calculator-report" class="quote" style="display: block">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<form action="" id="needs-calculator-demographics-form"
							...
							<div class="inline-text required">
								<input required="" class=" " pattern="[0-9]*" type="text"
									id="calc-annual-income" name="annual-income" disabled maxlength="25">
							...
							<div class="inline-select required complete">
								<input required="" class=" " pattern="[0-9]*" type="text"
									id="calc-coverage" name="coverage" maxlength="25" disabled> <label
