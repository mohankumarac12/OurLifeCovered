            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p>To create your customized term life insurance quote please fill in the blanks and answer the questions below.</p>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-md-12">
                        <form action="" id="needs-calculator-demographics-form" name="needsCalculatorDemographicsForm">
                           ...
                           <div class="inline-select required complete">
                            ...
                            <!-- <div class="inline-text required">
                                <input type ="hidden"  pattern="[0-9]*" id="calc-form-phone" name="calc-form-phone">
                                
                            </div> -->
                            <div class="text-center">
                                <input type="button" class="btn btn-primary" value="Get Your Quote" id="quote-form-submit" wpvalue="next" onclick="validateQuote('affordability,natlang')">
                            </div>
