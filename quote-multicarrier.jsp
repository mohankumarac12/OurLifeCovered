...
<div id="quote_multicarrier" class="background-wrap">
	<section id="quote-page" class="cover main-section">
	    <div class="container">
		            ...
		            <div class="row">
		                ...
		                <div class="column">
		                	<div class="coverage-term">
			                    <p>Coverage: <span class="price">$1,400,000</span></p>
			                    <p>Term: <span class="term">20 years</span></p>
			                </div>
			                <div class="phone">
		                    	<p>Call to learn more <a href="tel:18888888888">1-888-888-8888</a></p>
		                    </div>
		                </div>
		            </div>
		            <div class="row">
		    ...
		    <div id="legal_policy">
		    	<a href="policyForms.do">Legal Policy <i class="fa fa-angle-right" aria-hidden="true"></i></a>
		    </div>
	    </div>
	</section>
